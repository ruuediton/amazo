        ...
        <main className="flex-1 overflow-y-auto px-6 pt-8 pb-32 no-scrollbar">
          ...
          <div className="flex justify-center gap-6 mb-10">
            <div className="flex flex-col items-center gap-2">
              <div className="size-12 rounded-full bg-green-500/10 border border-green-500/30 flex items-center justify-center">
                <span className="material-symbols-outlined text-green-500 text-[24px]" style={{ fontVariationSettings: "'FILL' 1" }}>verified_user</span>
              </div>
              <span className="text-[9px] font-bold text-gray-500 uppercase text-center tracking-tighter">Dados<br />Protegidos</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-[9px] font-bold text-gray-500 uppercase text-center tracking-tighter">SSL<br />256-BIT</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-[9px] font-bold text-gray-500 uppercase text-center tracking-tighter">Lei<br />22/11 AO</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-10">
            ...
            {/* Nota de Auditoria */}
            <div className="mt-4 p-5 rounded-2xl bg-white/5 border border-white/10 flex flex-col gap-3">
            ...
            <section className="pb-12 pt-6">
              <p className="text-[10px] text-gray-600 leading-relaxed text-center font-bold uppercase tracking-widest">
...
const LegalSection = ({ number, title, content }: { number: string, title: string, content: string }) => (
  <section className="flex flex-col gap-3">
    ...
    <p className="text-text-secondary text-[13px] leading-relaxed pl-10 border-l border-gray-200">
      {content}
    </p>
  </section>
);
