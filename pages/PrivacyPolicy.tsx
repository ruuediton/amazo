      ...
      <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-white">
        ...
        <header className="relative bg-gradient-to-b from-[#00C853] to-[#00C853]/10 pb-8 pt-4 px-4 overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            <h1 className="text-xl font-black text-white tracking-tight text-center">Privacidade</h1>
          ...
          <div className="flex flex-col gap-10">
            <section>
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                A BP Angola Digital Services, SA (adiante "BP") assume o compromisso de proteger a privacidade dos seus utilizadores em conformidade com a <span className="text-black font-bold italic underline decoration-primary/40">Lei n.º 22/11 – Lei da Protecção de Dados Pessoais</span> da República de Angola.
              </p>
            </section>
