          ...
          <div className="relative">
            ...
            {isFilterOpen && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-48 bg-surface-dark border border-white/10 rounded-2xl shadow-2xl z-20 py-2 overflow-hidden animate-in fade-in zoom-in duration-200 origin-top-right">
