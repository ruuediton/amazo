...
const Support: React.FC<SupportProps> = ({ onNavigate }) => {
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-background-dark font-display text-black">
      {/* Header */}
      <div className="flex items-center px-4 py-4 justify-between sticky top-0 z-10 bg-background-dark/95 border-b border-gray-200">
        <button
      ...
      <div className="px-4 flex flex-col gap-4">
        ...
        <div className="px-4 flex flex-col gap-4">
          {/* Support Card */}
          <div className="flex flex-col rounded-xl bg-surface-dark p-5 border border-gray-200">
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center rounded-xl h-14 px-4 bg-primary text-background-dark text-base font-black leading-normal transition-all active:scale-[0.98]"
            >
      ...
      <div className="px-4 py-6">
        ...
        <div className="flex flex-col rounded-xl bg-surface-dark overflow-hidden border border-gray-200">
          {/* FAQ Items */}
          {[
