...
const Report: React.FC<ReportProps> = ({ onNavigate }) => {
  const [selectedCategory, setSelectedCategory] = useState('Transa̤̣o');

  const categories = ['Transa̤̣o', 'Conta', 'Bug no App', 'Outros'];
  ...
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden bg-background-dark font-display text-black antialiased">
      ...
      <header className="sticky top-0 z-10 flex items-center bg-background-dark p-4 pb-2 justify-between border-b border-gray-200">
        ...
        <h2 className="text-black text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-12">Relatar Problema</h2>
      </header>
      ...
      <main className="flex-1 flex flex-col pb-24">
        ...
        <div className="px-5 py-2">
          <label className="flex flex-col w-full">
            <span className="text-black text-base font-bold leading-normal pb-3">Descri̤̣o do Problema</span>
            <textarea
              ...
              placeholder="Digite aqui os detalhes (ex: ID da transa̤̣o, mensagem de erro)..."
            ></textarea>
          </label>
        </div>
        ...
        {/* Attachments Section */}
        <div className="px-5 pt-6 pb-2">
          <h3 className="text-black text-lg font-bold leading-tight tracking-tight pb-4">Anexar evid̻ncias (Opcional)</h3>
        ...
        <div className="mt-auto px-5 pt-8 pb-4 text-center">
          <div className="flex items-center justify-center gap-2 text-gray-600 mb-6">
            ...
            <p className="text-xs font-medium">Seus dados ṣo enviados de forma segura e criptografada.</p>
          </div>
