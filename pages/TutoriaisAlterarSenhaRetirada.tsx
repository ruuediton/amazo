          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-end pt-1">
                <button className="text-sm font-medium text-text-secondary hover:text-primary transition-colors underline decoration-primary/30 underline-offset-4">
                  Esqueceu a senha?
                </button>
              </div>
            </div>
            ...
            <div className="space-y-1 pt-2">
              ...
              {/* Security Checklist */}
              <div className="p-4 mt-3 rounded-xl bg-surface-dark/50 border border-border-dark/50">
                <p className="text-xs font-semibold text-text-secondary uppercase tracking-wider mb-3">Requisitos de segurança</p>
