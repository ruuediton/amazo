        ...
        <main className="flex-1 overflow-y-auto px-6 pt-8 pb-32 no-scrollbar">
          ...
          <div className="flex flex-col gap-10">
            ...
            <RuleBlock
              ...
              content="O valor mínimo de saque é de 1.000 Kz. A amazon reserva-se o direito de aplicar taxas administrativas sobre transações de acordo com o nível da conta do utilizador e as parcerias interbancárias vigentes."
            />
