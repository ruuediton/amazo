...
const Campaigns: React.FC<Props> = ({ onNavigate }) => {
  return (
    <div className="bg-background-dark font-display text-black antialiased min-h-screen pb-24">
      {/* Top App Bar */}
      <header className="flex items-center justify-between px-4 py-3 bg-background-dark sticky top-0 z-20 border-b border-gray-200">
        <button
      ...
      <section className="mt-4">
        ...
        <div className="flex flex-col gap-4 px-4">
          ...
          <div className="group overflow-hidden rounded-2xl bg-surface-dark border border-gray-200 transition-all">
            <div className="relative h-44 w-full overflow-hidden">
              ...
              <div className="absolute top-3 right-3">
                <span className="px-2 py-1 bg-black/60 text-primary text-[10px] font-bold rounded flex items-center gap-1">
