  ...
  return (
    <div className="bg-background-dark font-display text-black antialiased min-h-screen relative overflow-hidden flex flex-col">
      ...
      <header className="relative z-10 flex w-full items-center justify-between p-4 pt-8">
        <button className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 backdrop-blur-sm transition-all hover:bg-[#25D366]/20 active:scale-95 group border border-white/10">
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 backdrop-blur-sm transition hover:bg-primary hover:text-background-dark active:scale-95 group border border-primary/20"
        >
      ...
      <div className="flex flex-1 flex-col items-center overflow-y-auto px-6 pb-6 no-scrollbar">
        ...
        <div className="relative mb-8 mt-4 flex w-full max-w-sm flex-col items-center justify-center">
          <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-white/5 shadow-2xl ring-1 ring-white/10">
        ...
        <div className="w-full max-w-sm space-y-3 pb-8">
          <button
            ...
            className="group relative flex h-14 w-full items-center justify-center overflow-hidden rounded-xl bg-primary text-background-dark shadow-lg shadow-primary/20 transition-all hover:bg-[#eac410] hover:shadow-primary/40 active:scale-[0.98] cursor-pointer"
          >
