  ...
  const generateManual = () => {
    try {
      ...
      addSection('REGULAMENTO INTERNO',
        ...
        "02. Limites e Taxas\nO valor mínimo de saque é de 1.000 Kz. A SmartBuy reserva-se o direito de aplicar taxas administrativas sobre transações de acordo com o nível da conta do utilizador e as parcerias interbancárias vigentes.\n\n" +
      ...
      addSection('TERMOS E CONDIÇÕES',
        ...
        "Bem-vindo à SmartBuy. Ao utilizar o nosso aplicativo e serviços bancários integrados, você concorda com os termos descritos abaixo.\n\n" +
        ...
        "02. Serviços Financeiros\nTodas as transações são efetuadas em Kwanzas (Kz). Depósitos via Multicaixa Express possuem tempo médio de compensação de 5 minutos, enquanto retiradas bancárias podem levar até 24 horas úteis. *A SmartBuy não se responsabiliza por dados de IBAN inseridos incorretamente.\n\n" +
        "03. Marketplace e Ganhos\nA aquisição de dispositivos na loja SmartBuy integrada concede ao utilizador o direito de participar de campanhas de recompensas por tarefas. Os rendimentos diários são variáveis.\n\n" +
        "04. Segurança\nO utilizador é o único responsável por manter o sigilo de sua senha. A SmartBuy nunca solicitará sua senha por WhatsApp ou e-mail.");
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h1 className="text-2xl font-extrabold tracking-tight text-[#111418]">
              {currentProfile.full_name || 'Usuário SmartBuy'}
            </h1>
