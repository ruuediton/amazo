...
const Profile: React.FC<ProfileProps> = ({ onNavigate, onLogout, profile, showToast }) => {
  ...
  const generateManual = () => {
    try {
      ...
      doc.setFontSize(40);
      doc.setTextColor(15, 17, 17); // BP Black
      doc.text('APRENDE', 105, 100, { align: 'center' });
      doc.text('BP', 105, 115, { align: 'center' });
      ...
      // Header Bar
      doc.setFillColor(35, 47, 62); // BP Dark Blue
      doc.rect(0, 0, 210, 30, 'F');
      doc.setTextColor(255, 255, 255);
      doc.setFontSize(18);
      doc.text('Bem-vindo ao BP App', 10, 20);
      ...
      const addSection = (title: string, content: string) => {
        ...
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(14);
        doc.setTextColor(228, 121, 17); // BP Orange
      ...
      addSection('5. Como Enviar Comprovante',
        ...
        "3. Falar com Gerente: Inicie uma conversa com seu Gerente de conta BP (verifique o selo de verificação).\n" +
      ...
      addSection('TERMOS E CONDIÇÕES',
        ...
        "Bem-vindo à BP. Ao utilizar o nosso aplicativo e serviços bancários integrados, você concorda com os termos descritos abaixo.\n\n" +
        ...
        "02. Serviços Financeiros\nTodas as transações são efetuadas em Kwanzas (Kz). Depósitos via Multicaixa Express possuem tempo médio de compensação de 5 minutos, enquanto retiradas bancárias podem levar até 24 horas úteis. *A BP não se responsabiliza por dados de IBAN inseridos incorretamente.\n\n" +
        "03. Marketplace e Ganhos\nA aquisição de dispositivos na loja BP integrada concede ao utilizador o direito de participar de campanhas de recompensas por tarefas. Os rendimentos diários são variáveis.\n\n" +
        "04. Segurança\nO utilizador é o único responsável por manter o sigilo de sua senha. A BP nunca solicitará sua senha por WhatsApp ou e-mail.");

      addSection('DECLARAÇÃO DE PRIVACIDADE',
        "A BP Angola Digital Services, SA assume o compromisso de proteger a privacidade dos seus utilizadores em conformidade com a Lei n.º 22/11 – Lei da Protecção de Dados Pessoais da República de Angola.\n\n" +
      ...
      doc.text("BP Angola Digital Services, SA", 10, yPos);
      ...
      link.href = url;
      link.download = 'Manual_BP_Guia.pdf'; // Simplified, sure-fire extension
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h1 className="text-2xl font-extrabold tracking-tight text-[#111418]">
              {currentProfile.full_name || 'Usuário BP'}
            </h1>
