...
const TutoriaisComoConvidar: React.FC<Props> = ({ onNavigate }) => {
  ...
  const steps = [
    ...
    {
      title: "Registe seus Amigos",
      description: "Envie diretamente para seus aplicativos favoritos como WhatsApp, Telegram e Instagram.",
      icon: "share"
    },
    {
      title: "Aumente suas Recompensas",
      description: "Partilhe em grupos e stories para atrair mais pessoas e receber bônus por cada novo amigo.",
      icon: "trending_up"
    }
  ];
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white font-sans text-black flex flex-col">
      <header className="sticky top-0 z-50 bg-white p-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <h1 className="text-base font-bold text-center flex-1 tracking-tight">Convidar</h1>
      ...
      >
        <div className="max-w-md mx-auto space-y-8">
          <div className="flex items-center gap-4 bg-gray-50 p-5 rounded-[32px] border border-gray-100">
            ...
            <div>
              <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Programa BP</span>
          ...
          <div className="bg-gray-50 p-6 rounded-[32px] border border-gray-100 italic text-[12px] text-gray-400 font-medium text-center">
            "O crescimento da sua rede na BP Angola garante recompensas diárias progressivas."
          </div>
        </div>
      </main>
