...
const TutoriaisGanhosTarefas: React.FC<Props> = ({ onNavigate }) => {
  ...
  const steps = [
    {
      title: "Aceda à Página",
      description: "No menu inferior, toque no ícone de Raio (Operações) para ver o seu painel de controle.",
      icon: "bolt"
    },
    {
      title: "Acompanhe seu Saldo",
      description: "O seu saldo é atualizado em tempo real. O valor acumulado aumenta conforme as suas tarefas são processadas.",
      icon: "account_balance_wallet"
    },
    {
      title: "Check-in Diário",
      description: "Utilize o botão central diariamente para coletar as suas recompensas e manter o sistema ativo.",
      icon: "power_settings_new"
    },
    {
      title: "Planos Ativos",
      description: "Verifique a lista para ver quais planos estão em execução e o desempenho individual de cada um.",
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white font-sans text-black flex flex-col">
      <header className="sticky top-0 z-50 bg-white p-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <h1 className="text-base font-bold text-center flex-1 tracking-tight">Gestão de Recompensas</h1>
      ...
      >
        <div className="max-w-md mx-auto space-y-8">
          <div className="flex items-center gap-4 bg-gray-50 p-5 rounded-[32px] border border-gray-100">
            ...
            <div>
              <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Rendimento</span>
          ...
          <div className="bg-gray-50 p-6 rounded-[32px] border border-gray-100 italic text-[12px] text-gray-400 font-medium text-center">
            "As tarefas são processadas automaticamente em períodos de 24 horas, garantindo bônus constantes na sua conta BP Angola."
          </div>
        </div>
      </main>
