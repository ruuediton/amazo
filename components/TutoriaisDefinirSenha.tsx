  ...
  const steps = [
    {
      ...
      description: "Evite números fáceis como 1234 ou 1111 para garantir a segurança das suas recompensas.",
      icon: "block"
    },
    {
      title: "Sem Datas",
      description: "Não utilize datas de nascimento ou anos previsíveis para as suas retiradas.",
      icon: "calendar_month"
    },
    {
      title: "Combinação Única",
      description: "A sua senha de saque deve ser diferente da sua senha de login no aplicativo.",
      icon: "fingerprint"
    }
  ];
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white font-sans text-black flex flex-col">
      <header className="sticky top-0 z-50 bg-white p-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <h1 className="text-base font-bold text-center flex-1 tracking-tight">Segurança</h1>
      ...
      >
        <div className="max-w-md mx-auto space-y-8">
          <div className="flex items-center gap-4 bg-gray-50 p-5 rounded-[32px] border border-gray-100">
            ...
            <div>
              <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Proteção</span>
          ...
          <div className="bg-red-50 p-6 rounded-[32px] border border-red-100 flex gap-3">
            <span className="material-symbols-outlined text-red-500 text-[20px] shrink-0">warning</span>
            <p className="text-[12px] text-red-600 font-bold leading-relaxed italic">
              Nunca partilhe esta senha com ninguém. A BP nunca solicita a sua senha secreta via atendimento.
            </p>
          </div>
        </div>
      </main>
